# Generated by Django 4.1.4 on 2022-12-28 02:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('LIBRARY', 'LIBRARY'), ('FRAMEWORK', 'FRAMEWORK'), ('SPA', 'SPA'), ('WEB APPLICATION', 'WEB APPLICATION'), ('SERVICE', 'SERVICE'), ('DRIVER', 'DRIVER'), ('MICROCONTROLLER', 'MICROCONTROLLER'), ('GAME', 'GAME'), ('OS', 'OS'), ('DATABASE', 'DATABASE'), ('DATABASE MANAGEMENT SYSTEM', 'DATABASE MANAGEMENT SYSTEM'), ('COMPILER', 'COMPILER'), ('INTERPRETER', 'INTERPRETER'), ('PROGRAM LANGUAGE', 'PROGRAM LANGUAGE'), ('ARCHIVER', 'ARCHIVER'), ('ANTIVIRUS', 'ANTIVIRUS'), ('FIREWALL', 'FIREWALL'), ('REDACTOR', 'REDACTOR'), ('BROWSER', 'BROWSER'), ('FILE MANAGER', 'FILE MANAGER')], max_length=50)),
                ('is_private', models.BooleanField(blank=True, default=False)),
        ...
        migrations.CreateModel(
            name='SpecialistOwnProject',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('own_project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.project')),
                ('specialist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('JOIN_TO_TEAM', 'JOIN_TO_TEAM'), ('ADD_TO_TEAM', 'ADD_TO_TEAM'), ('GIVE_OWNERSHIP', 'GIVE_OWNERSHIP'), ('GET_OWNERSHIP', 'GET_OWNERSHIP')], max_length=50)),
                ('response', models.BooleanField(blank=True, default=None, null=True)),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.project')),
        ...
        migrations.AddField(
            model_name='specialist',
            name='own_projects',
            field=models.ManyToManyField(related_name='own_projects', through='core.SpecialistOwnProject', to='core.project'),
        ),
        migrations.AddField(
            model_name='specialist',
            name='projects',
        ...
        migrations.AddConstraint(
            model_name='specialistownproject',
            constraint=models.UniqueConstraint(fields=('specialist', 'own_project'), name='specialist__own_project__constraint'),
        ),
        migrations.AddConstraint(
